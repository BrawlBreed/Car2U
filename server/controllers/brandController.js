...
const uploadFileToCloudinary = async (base64Data) => {
...
const createBrand = async (req, res) => {
  try {
    const { name, brandBase64Image } = req.body;

    if (!name || !brandBase64Image) {
    ...
    const cloudinaryUrl = await uploadFileToCloudinary(brandBase64Image);

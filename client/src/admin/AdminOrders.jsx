...
const AdminOrders = () => {
    ...
    const getOrders = async () => {
        try {
            const { data } = await axios.get(`${process.env.REACT_APP_URL ?  process.env.REACT_APP_URL : process.env.REACT_APP_API_URL}/api/user/allOrders`)
            setOrder(data)
        } catch (err) {
    ...
    const handleChange = async (orderId, value) => {
        try {
            const { data } = await axios.put(`${process.env.REACT_APP_URL ?  process.env.REACT_APP_URL : process.env.REACT_APP_API_URL}/api/user/orderStatus/${orderId}`, { status: value, });
            getOrders();

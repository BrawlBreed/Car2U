...
const CreateCar = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post(`${process.env.REACT_APP_URL ?  process.env.REACT_APP_URL : process.env.REACT_APP_API_URL}/api/car/create-car`, carData);
                                ...
                                <div className='m-1'>
                                    ...
                                    <div className='mb-3'>
                                        <input
                                            type='text'
                                            value={price}
                                            placeholder='write only car amount price not include Euro,Cr,Rupees etc...'
                                            className='form-control'

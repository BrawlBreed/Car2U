...
const UpdateCar = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.put(`${process.env.REACT_APP_URL ?  process.env.REACT_APP_URL : process.env.REACT_APP_API_URL}/api/car/update-car/${id}`, carData)
    ...
    const handleDelete = async () => {
        try {
            const { data } = await axios.delete(`${process.env.REACT_APP_URL ?  process.env.REACT_APP_URL : process.env.REACT_APP_API_URL}/api/car/delete-car/${id}`)

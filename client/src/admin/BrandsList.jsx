...
const CreateCategory = () => {
    ...
    const handleUpdate = async (e) => {
        e.preventDefault()
        try {
            const { data } = await axios.put(`${process.env.REACT_APP_URL ?  process.env.REACT_APP_URL : process.env.REACT_APP_API_URL}/api/brand/update-brand/${selected._id}`, { name: updatedName })
            if (data?.success) {
    ...
    const handleDelete = async (id) => {
        try {
            const { data } = await axios.delete(`${process.env.REACT_APP_URL ?  process.env.REACT_APP_URL : process.env.REACT_APP_API_URL}/api/brand/delete-brand/${id}`, { name: updatedName })
            if (data?.success) {

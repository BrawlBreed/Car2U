...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post(`${process.env.REACT_APP_URL ?  process.env.REACT_APP_URL : process.env.REACT_APP_API_URL}/api/user/login`, {
                email, password
            });
            if (res.data.success) {
                        ...
                        <form class="col-md-6 right-box">
                            <div class="row align-items-center">
                                ...
                                <div class="d-flex flex-row align-items-center mt-4 ">
                                    <div class="form-outline flex-fill mb-0">
                                        <button class="btn btn-lg  text-white" type="button" onClick={handleSubmit} style={{ backgroundColor: '#CC2B52', width: '100%' }} >Login</button>
                                    </div>
                                </div>

        ...
        <>
            <div className="brand_wrapper" id='cars'>
                <div className="col-12 text-center">
                    <p className="brand_subtitle">Разгледайте вълнуващи нови автомобили!</p>
                    <h2 className="brand_title">Най-новите предложения от автопарка</h2>
                </div>
            </div>
            {loading ?
                ...
                <div className="container">
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-body ">
                                        ...
                                        <div className='text-center'>
                                            ...
                                            <button className='btn my-2 mx-3 hover:bg-[#CC2B52]' style={{ backgroundColor: 'white', color: '#CC2B52', border: '1px solid #CC2B52' }} onClick={() => { setcart([...cart, p]); localStorage.setItem('cart', JSON.stringify([...cart, p])); notify() }} ><BiMessageAdd size={20} className='pb-1' /> Добави в запитване</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="col-12 text-center my-5">
                        <Link to='/cars' className='btn btn-lg text-white' style={{ backgroundColor: '#CC2B52' }}>
                            Виж повече модели <AiFillCar size={25} />
                        </Link>
                    </div>
                </div>
            }

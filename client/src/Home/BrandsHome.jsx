                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 text-center mb-5">
                            <p className="brand_subtitle">Открийте своята марка сред най-добрите</p>
                            <h2 className="brand_title">Актуални автомобили от доказани производители</h2>                        
                        </div>
                    </div>
                    {loading ?
                        ...
                        <>
                            ...
                            <div className="col-12 text-center">
                                <Link to='/brands' className='btn btn-lg text-white' style={{ backgroundColor: '#CC2B52' }}>
                                    Виж повече <FaCarSide size={25} />
                                </Link>
                            </div>
                        </>
                    }

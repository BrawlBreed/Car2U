        ...
        <header className={color ? 'header_wrapper header-scrolled' : 'header_wrapper'}>
            <nav className="navbar navbar-expand-lg fixed-top">
                <div className="container-fluid mx-3">
                    <Link to='/'>
                        <img src={logo} style={{ width: '130px' }} alt="Car2U Лого" />
                    </Link>
                    <button className="navbar-toggler pe-0" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Превключи навигация">
                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <ul className="navbar-nav menu-navbar-nav">
                            ...
                            <Link to='/brands' style={{ textDecoration: 'none' }}>
                                <li className="nav-item">
                                    <a className="nav-link">Марки</a>
                                </li>
                            </Link>
                            <Link to='/cars' style={{ textDecoration: 'none' }}>
                                <li className="nav-item">
                                    <a className="nav-link">Автомобили</a>
                                </li>
                            </Link>
                            <Link to='/cart' style={{ textDecoration: 'none' }}>
                                <li className="nav-item">
                                    <i className="fa"><AiOutlineShoppingCart size={25} color='#CC2B52' /></i>
